...
// Corpus guard for the canonical chord engine, preserved from the retired classic adapter.
//
...
describe('chord-demo naming (ported from live-chord-monitor)', () => {
...
describe('chord-demo candidate ranking', () => {
