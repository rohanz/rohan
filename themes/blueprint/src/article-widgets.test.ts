...
describe('blueprint article-widgets chord naming (ported from live-chord-monitor)', () => {
...
describe('blueprint article-widgets chord spelling', () => {
...
describe('blueprint article-widgets candidate ranking', () => {
