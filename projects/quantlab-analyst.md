...
6. **Fine-tuning tunes what you aim it at, and nothing else.** The gate metrics I optimised reached frontier level; the prose quality I never targeted didn't move, even when I finally targeted it directly. Verifiability and quality are different axes, and this system honestly claims only one.
