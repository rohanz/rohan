...
But v2.1's per-number accuracy sat at 95.4%, and no amount of blind training moved it. At 40 numbers a memo, 95% per number means most memos carry at least one bad one, and the gate fails them whole. The errors weren't fabrications anymore, though, just imperfect transcription, like turning "168.6 billion shares" into 165. **36% of memos survived.** That meant I was finally past the timid base model, but nowhere near the teacher's 93%.
