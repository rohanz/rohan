...
Somewhere in there I discovered my measuring instrument was lying to me: I'd been evaluating models through aggressive 4-bit compression, which was silently garbling the fine-tuned <span class="gloss-term" data-gloss="The billions of learned numbers that make up a trained model. Damage them and the behaviour degrades in subtle ways.">weights</span> and costing about 7 accuracy points. Every number in this article comes from after that fix. Lesson one of the project: **evaluate the artefact you trained, not the artefact you deploy.**
